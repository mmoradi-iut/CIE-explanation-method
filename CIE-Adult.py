...
def main(argv):
    ...
    temp_feature = Feature('workclass', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('fnlwgt', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('education', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('education-num', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('marital-status', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('occupation', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('relationship', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('race', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('sex', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('capital-gain', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('capital-loss', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('hours-per-week', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('native-country', 2)
    Feature_list.append(temp_feature)
    
    Class_list = []
    Class_list.append(' <=50K')
    Class_list.append(' >50K')
    ...
    with open('Train\\Adult-Train.csv') as input_file:
    ...
    for i in range(0, len(Feature_list)):
        ...
        if (i == 2): #----- fnlwgt
            ...
            temp_item1 = Item(i, 0, Feature_list[i].type)
            temp_item1.is_range = True
            temp_item1.max_value = int(50000)
            
            temp_item2 = Item(i, 0, Feature_list[i].type)
            temp_item2.is_range = True
            temp_item2.min_value = int(50001)
            temp_item2.max_value = int(150000)
            
            temp_item3 = Item(i, 0, Feature_list[i].type)
            temp_item3.is_range = True
            temp_item3.min_value = int(150001)
            temp_item3.max_value = int(250000)
            
            temp_item4 = Item(i, 0, Feature_list[i].type)
            temp_item4.is_range = True
            temp_item4.min_value = int(250001)
            temp_item4.max_value = int(350000)
            
            temp_item5 = Item(i, 0, Feature_list[i].type)
            temp_item5.is_range = True
            temp_item5.min_value = int(350001)
        ...
        if (i == 4): #----- education-num
            ...
            temp_item2.max_value = int(8)
            
            temp_item3 = Item(i, 0, Feature_list[i].type)
            temp_item3.is_range = True
            temp_item3.min_value = int(9)
            temp_item3.max_value = int(12)
            
            temp_item4 = Item(i, 0, Feature_list[i].type)
            temp_item4.is_range = True
            temp_item4.min_value = int(13)
                
            temp_item1.frequency = temp_item2.frequency = temp_item3.frequency = temp_item4.frequency = 0
        ...
        if (i == 10): #----- capital-gain
            ...
            temp_item2.max_value = int(1000)
            
            temp_item3 = Item(i, 0, Feature_list[i].type)
            temp_item3.is_range = True
            temp_item3.min_value = int(1001)
        ...
        if (i == 12): #----- hours-per-week
            ...
            temp_item5.max_value = int(75)
            
            temp_item6 = Item(i, 0, Feature_list[i].type)
            temp_item6.is_range = True
            temp_item6.min_value = int(76)
    ...
    #-------------------- End of itemset mining algorithm
    ...
    output_file_name = 'Train\\Train-Sup' + str(support_threshold) + '-Conf' + str(confidence_threshold) + '.txt'
    ...
    output_file_name = 'Train\\Train-Sup' + str(support_threshold) + '-Conf' + str(confidence_threshold) + '.xml'
    output_file = open(output_file_name, 'w')
    ...
    Record_list = []
    with open('Test\\Adult-Test.csv') as input_file:
    ...
    model = xml.dom.minidom.parse('Train\\Train-Sup' + str(support_threshold) + '-Conf' + str(confidence_threshold) + '.xml')
    ...
    output_file = open('Test\\Adult-Result.txt', 'w')
