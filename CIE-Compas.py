...
def main(argv):
    ...
    temp_feature = Feature('race', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('age_cat', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('marital_status', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('custody_status', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('person_decile_score', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('priors_count', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('c_charge_degree', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('is_violent_recid', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('rec_supervision_level_text', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('type_of_assessment', 2)
    Feature_list.append(temp_feature)
    temp_feature = Feature('raw_score', 1)
    Feature_list.append(temp_feature)
    temp_feature = Feature('compas_decile_score', 1)
    Feature_list.append(temp_feature)
    
    Class_list = []
    Class_list.append('Low')
    Class_list.append('Medium')
    ...
    with open('Train\\Compas-Train.csv') as input_file:
    ...
    #---------- For every numerical feature, create some ranges
    
    for i in range(0, len(Feature_list)):
        
        if (i == 5): #----- person_decile_score
                
            temp_item1 = Item(i, 0, Feature_list[i].type)
            temp_item1.is_range = True
            temp_item1.max_value = int(0)
            
            temp_item2 = Item(i, 0, Feature_list[i].type)
            temp_item2.is_range = True
            temp_item2.min_value = int(1)
            temp_item2.max_value = int(2)
            
            temp_item3 = Item(i, 0, Feature_list[i].type)
            temp_item3.is_range = True
            temp_item3.min_value = int(3)
            temp_item3.max_value = int(4)
            
            temp_item4 = Item(i, 0, Feature_list[i].type)
            temp_item4.is_range = True
            temp_item4.min_value = int(5)
            temp_item4.max_value = int(6)
            
            temp_item5 = Item(i, 0, Feature_list[i].type)
            temp_item5.is_range = True
            temp_item5.min_value = int(7)
            temp_item5.max_value = int(8)
            
            temp_item6 = Item(i, 0, Feature_list[i].type)
            temp_item6.is_range = True
            temp_item6.min_value = int(9)
                
            temp_item1.frequency = temp_item2.frequency = temp_item3.frequency = temp_item4.frequency = temp_item5.frequency = temp_item6.frequency = 0
            ...
            range_itemlist.items.append(temp_item6)
        ...
        if (i == 6): #----- priors_count
            ...
            temp_item2.max_value = int(3)
            
            temp_item3 = Item(i, 0, Feature_list[i].type)
            temp_item3.is_range = True
            temp_item3.min_value = int(4)
            temp_item3.max_value = int(5)
            
            temp_item4 = Item(i, 0, Feature_list[i].type)
            temp_item4.is_range = True
            temp_item4.min_value = int(6)
            temp_item4.max_value = int(10)
            
            temp_item5 = Item(i, 0, Feature_list[i].type)
            temp_item5.is_range = True
            temp_item5.min_value = int(11)
            temp_item5.max_value = int(20)
            
            temp_item6 = Item(i, 0, Feature_list[i].type)
            temp_item6.is_range = True
            temp_item6.min_value = int(21)
            temp_item6.max_value = int(30)
            
            temp_item7 = Item(i, 0, Feature_list[i].type)
            temp_item7.is_range = True
            temp_item7.min_value = int(31)
                
            temp_item1.frequency = temp_item2.frequency = temp_item3.frequency = temp_item4.frequency = temp_item5.frequency = temp_item6.frequency = temp_item7.frequency = 0
            ...
            range_itemlist.items.append(temp_item5)
            range_itemlist.items.append(temp_item6)
            range_itemlist.items.append(temp_item7)
        ...
        if (i == 11): #----- education-num
                
            temp_item1 = Item(i, 0, Feature_list[i].type)
            temp_item1.is_range = True
            temp_item1.max_value = double(-3.0)
            
            temp_item2 = Item(i, 0, Feature_list[i].type)
            temp_item2.is_range = True
            temp_item2.min_value = double(-2.99)
            temp_item2.max_value = double(-1.0)
            
            temp_item3 = Item(i, 0, Feature_list[i].type)
            temp_item3.is_range = True
            temp_item3.min_value = double(-0.99)
            temp_item3.max_value = double(0.0)
            
            temp_item4 = Item(i, 0, Feature_list[i].type)
            temp_item4.is_range = True
            temp_item4.min_value = double(0.01)
            temp_item4.max_value = double(3.0)
            
            temp_item5 = Item(i, 0, Feature_list[i].type)
            temp_item5.is_range = True
            temp_item5.min_value = double(3.01)
            temp_item5.max_value = double(10.0)
            
            temp_item6 = Item(i, 0, Feature_list[i].type)
            temp_item6.is_range = True
            temp_item6.min_value = double(10.01)
            temp_item6.max_value = double(21.0)
            
            temp_item7 = Item(i, 0, Feature_list[i].type)
            temp_item7.is_range = True
            temp_item7.min_value = double(21.01)
            temp_item7.max_value = double(29.0)
            
            temp_item8 = Item(i, 0, Feature_list[i].type)
            temp_item8.is_range = True
            temp_item8.min_value = double(29.01)
                
            temp_item1.frequency = temp_item2.frequency = temp_item3.frequency = temp_item4.frequency = temp_item5.frequency = temp_item6.frequency = temp_item7.frequency = temp_item8.frequency = 0
            ...
            range_itemlist.items.append(temp_item6)
            range_itemlist.items.append(temp_item7)
            range_itemlist.items.append(temp_item8)
        ...
        if (i == 12): #----- compas_decile_score
                
            temp_item1 = Item(i, 0, Feature_list[i].type)
            temp_item1.is_range = True
            temp_item1.max_value = int(4)
            
            temp_item2 = Item(i, 0, Feature_list[i].type)
            temp_item2.is_range = True
            temp_item2.min_value = int(5)
            temp_item2.max_value = int(7)
            
            temp_item3 = Item(i, 0, Feature_list[i].type)
            temp_item3.is_range = True
            temp_item3.min_value = int(8)
                
            temp_item1.frequency = temp_item2.frequency = temp_item3.frequency = 0
    ...
    Record_list = []
    with open('Test\\Compas-Test.csv') as input_file:
